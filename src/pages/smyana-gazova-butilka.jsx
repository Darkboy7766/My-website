...
const SmyanaGazovaButilka = () => {
  return (
    <>
      <title>Смяна на Газова Бутилка след 10 Години | Аутогаз Варна</title>
      <meta
        name="description"
        content="Изтича ли 10-годишният срок на газовата ви бутилка? Предлагаме сертифициран монтаж на нова бутилка по ECE R67 с актуализация на документи. Варна и региона."
      />
      <link rel="canonical" href="https://autogas-varna.com/smyana-gazova-butilka" />

      <script type="application/ld+json">
        {JSON.stringify({
          '@context': 'https://schema.org',
          '@type': 'Service',
          name: 'Смяна на газова бутилка',
          provider: {
            '@type': 'AutoRepair',
            name: 'Аутогаз Варна',
          ...
          description:
            'Подмяна на газова бутилка за автомобил след изтичане на 10-годишния срок на експлоатация. Сертифицирани бутилки по ECE R67-01 с актуализация на документи.',
          areaServed: 'Варна и региона',
        })}
      </script>

      <Promo
        title="Смяна на газова бутилка"
        subTitle="10 години изтекоха? Подменете бутилката навреме – за ваша безопасност и безпроблемен технически преглед."
      />
