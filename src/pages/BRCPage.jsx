    ...
    <div className="min-h-screen bg-white pt-24 pb-16 px-5">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center">
          <Link to="/prices" className="inline-flex items-center gap-2 bg-blue-600 text-white px-8 py-4 rounded-full font-bold hover:bg-blue-700 transition-all shadow-lg">
