...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Да! Специализираните системи 5-то и 6-то поколение за TSI, GDI и FSI двигатели гарантират пълна защита и ефективност. Притежаваме пълното техническо оборудване за такъв монтаж във Варна.'
    },
    {
      question: 'Каква е поддръжката?',
      answer: 'На всеки 15 000 км се препоръчва смяна на филтри и диагностика. Това гарантира дълъг живот на системата и оптимален разход. Ние от Аутогаз-Варна ООД предлагаме пълно сервизно обслужване.'
    },
  ];
    ...
    <section className="py-10 bg-white px-5 relative">
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <Link to="/Contact" className="inline-block bg-white text-indigo-600 px-8 py-3 rounded-full font-bold hover:bg-indigo-50 transition-colors">
            Свържи се с нас
          </Link>
        </motion.div>
      </div>
