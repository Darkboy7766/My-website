...
const Testimonial = () => {
  return (
    <div className="flex flex-col items-center text-center">
            <Title title="Клиентите за нас" subTitle="Какво казват клиентите за нас. Доволните клиенти са нашия най-важен стимул." />
            <div className="flex flex-wrap items-center justify-center gap-4" >
                <div className="flex flex-col items-center bg-white px-3 py-8 rounded-lg border border-gray-300/80 max-w-68 text-sm text-center text-gray-500">
