...
const PriceCard1 = () => {
  return (
    <><div>
          <Title title="Цени за двигатели MPI" subTitle="Газови уредби за автомобили с индиректно впръскване (MPI)" />
          <div className="flex items-center justify-center flex-wrap gap-8 w-full">
              <div className="bg-blue-100/80 border border-blue-500/20 text-sm text-gray-500 flex flex-col items-center w-90 rounded-lg">
                  <div className="flex items-center justify-between w-full px-4 py-2">
                      <div className="flex items-center justify-between gap-4">
                          ...
                          <p className="text-lg text-blue-500  font-semibold ml-20">BRC</p>
                      </div>
              ...
              <div className="bg-blue-100/80 border border-blue-500/20 text-sm text-gray-500 flex flex-col items-center w-90 rounded-lg">
                  <div className="flex items-center justify-between w-full px-4 py-2">
                      <div className="flex items-center justify-between gap-4">
                          ...
                          <p className="text-lg text-blue-500  font-semibold ml-20">PRINS</p>
                      </div>
              ...
              <div className="bg-blue-100/80 border border-blue-500/20 text-sm text-gray-500 flex flex-col items-center w-90 rounded-lg">
                  <div className="flex items-center justify-between w-full px-4 py-2">
                      <div className="flex items-center justify-between gap-4">
                          ...
                          <p className="text-lg text-blue-500  font-semibold ml-20">AEB</p>
                      </div>
      ...
      </div><div className='mt-20 mb-20'>
              <Title title="Цени за двигатели FSI, TFSI, TSI, GDI, DI" subTitle="Газови уредби за автомобили с директно впръскване (FSI, TFSI, TSI, GDI, DI)" />
              <div className="flex items-center justify-center flex-wrap gap-8 w-full">
                  <div className="bg-blue-100/80 border border-blue-500/20 text-sm text-gray-500 flex flex-col items-center w-90 rounded-lg">
                      <div className="flex items-center justify-between w-full px-4 py-2">
                          <div className="flex items-center justify-between gap-4">
